...
<head>
    ...
    <![endif]-->
    <title>Personal Website - Nurul Hakim</title>
...
<body>
            ...
            <div class="container banner-content">
                <div id="da-slider" class="da-slider">
                    <div class="da-slide">
                        ...
                        <p>Studied at the Sumatran Technological Institute</p>
                        <div class="da-img"></div>
                    </div>
                    <div class="da-slide">
                        <h2>KSR PMI Unit ITERA</h2>
                        <p>Volunter of Palang Merah Indonesia</p>
                        <div class="da-img"></div>
                    </div>
                    <div class="da-slide">
                        <h2>HTML5/CSS</h2>
    ...
    <section id="introText">
        <div class="container">
            ...
            <h1>Selamat datang di Personal Website Nurul Hakim</h1>
              <p>Seorang mahasiswa yang Ngambis tiap waktu! Semangat gaess ;)</p>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center tileBox">
                   <div class="txtHead"> <i class="fa fa-desktop"></i>
                    <h3>Informatics Engineering <span class="id-color">Student</span></h3></div>
                    <p>Sedang menempuh studi Strata-1 Teknik Informatika di Institut Teknologi Sumatera</p>
                </div>
                <!-- end: -->
                ...
                <div class="col-md-4 text-center tileBox">
                    ...
                    <h3>Are Studying <span class="id-color">HTML 5 and CSS</span></h3></div>
                    <p>SEMANGATTTT!</p>
                </div>
                <!-- end: -->
                ...
                <div class="col-md-4 text-center tileBox">
                    ...
                    <h3>Kors Sukarela PMI<span class="id-color"> Unit ITERA</span></h3></div>
                    <p>Korps Sukarela (KSR) adalah kesatuan unit PMI yang menjadi wadah bagi anggota biasa dan perseorangan yang atas kesadaran sendiri menyatakan menjadi anggota KSR.</p>
                </div>
                <!-- end: -->
            </div>
        </div>
    ...
    <section id="quote" class="bg-parlex">
        <div class="parlex-back">
            <div class="container secPad text-center">
               <h2>Life is a game.</h2><p><b>(QS. Al-An'am : 32)</b></p>
            </div>
            <!--/.container-->
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row mrgn30">
                ...
                <div class="col-sm-4">
                    <h4>Address:</h4>
                    <address>
                        Jl. Sultan Jamil No. 29<br>
                        Kel Gedong Meneng, Kec Rajabasa<br>
